...
const RewriteSettingsModal: React.FC<RewriteSettingsModalProps> = ({ onClose }) => {
  const { rewriteSettings, updateSettings } = useRewriteStore();
  const [settings, setSettings] = useState(rewriteSettings);
  const [selectedPreset, setSelectedPreset] = useState('custom');

  const presets = [
    { id: 'casual', name: '轻松口语化', description: '使用更多日常用语，风格轻松活泼' },
    { id: 'professional', name: '专业正式', description: '使用专业术语，风格严谨正式' },
    { id: 'creative', name: '创意活泼', description: '富有创意和想象力，风格生动活泼' },
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <div className="p-6">
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">预设方案</h3>
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-gray-700 font-medium mb-2">文风类型</label>
              <select
                name="style"
              ...
              >
                <option value="casual">轻松口语化</option>
            ...
            <div>
              <label className="block text-gray-700 font-medium mb-2">
                长度调整: {settings.lengthAdjustment > 0 ? '+' : ''}{settings.lengthAdjustment}%
              </label>
              <input
                type="range"
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-gray-700 font-medium">必要保留关键词</label>
                <button
              ...
              {settings.keywords.length > 0 ? (
                ...
                <div className="text-center py-4 border-2 border-dashed border-gray-300 rounded-lg">
                  <p className="text-gray-500">暂无关键词，点击"添加关键词"按钮添加</p>
                </div>
              )}
            </div>
          </div>
