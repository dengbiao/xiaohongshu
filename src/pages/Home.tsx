...
const Home: React.FC = () => {
  return (
    <div className="max-w-6xl mx-auto">
      ...
      >
        <h1 className="text-4xl font-bold text-gray-800 mb-4">小红书内容智能改写助手</h1>
          ...
          >
            ...
            <Link to={card.path} className="block p-6">
              <div className="mb-4 text-white p-3 rounded-full inline-block bg-gradient-to-r w-14 h-14 flex items-center justify-center shadow-md transition-all duration-300 group-hover:scale-110">
                <div className={`bg-gradient-to-r ${card.color} rounded-full p-2`}>
                  {card.icon}
                </div>
              </div>
      ...
      >
        <h2 className="text-2xl font-bold text-gray-800 mb-4">开始您的高效创作之旅</h2>
        <p className="text-gray-600 mb-6">点击上方任意功能卡片，开始使用小红书内容智能改写助手</p>
        <Link 
          to="/fetch" 
